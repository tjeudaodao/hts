		...
		<div class="main">
			<div>
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<div class="row my-2 mx-2 justify-content-between">
											<input type="text" name="nhapmatong" placeholder="Nhập giá trị gần đúng" class="form-control col-8" id="textMatong" onclick="this.value=''">
									...
									<div class="modal-footer">
										<label class="text-secondary mx-3" style="font-size: 13px;">*** Ấn <strong>' ENTER '</strong> hoặc nút <strong>' Tìm '</strong> để lọc. Giới hạn hiển thị <strong>12</strong> kết quả</label>
				...
				<div class="row">
					...
					<p class="col-7 font-weight-bold font-italic text-center" style="font-size: 20px;"><span class="badge badge-success"><strong id="masanpham"></strong></span></p>
				</div>
					...
					<div class="modal-content">
						...
						<div class="modal-body text-secondary">
							<ul>
								...
								<li>Giới hạn phần <strong>LỌC</strong> cho hiển thị tối đa 12 kết quả</li>
